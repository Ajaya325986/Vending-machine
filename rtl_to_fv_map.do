...
# Generated on: Thu Jun 13 11:26:51 IST 2024 (Thu Jun 13 05:56:51 UTC 2024)
...
set logfile fv/vendingMachine/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
add_search_path /root/Documents/digital_demo1/vm -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /root/Documents/digital_demo1/vm/vendingMachine.v
...
set_system_mode lec
write_compared_points noneq.compared_points.vendingMachine.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.vendingMachine.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.vendingMachine.rtl.fv_map.rpt
